...
parser.add_argument("--model_file", type=str, required=True, default='./export/static_graph_params.pdmodel', help="The path to model info in static graph.")
parser.add_argument("--params_file", type=str, required=True, default='./export/static_graph_params.pdiparams', help="The path to parameters in static graph.")
parser.add_argument("--vocab_path", type=str, default="./data/senta_word_dict.txt", help="The path to vocabulary.")
